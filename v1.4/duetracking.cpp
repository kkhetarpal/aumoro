...
int main( int argc, const char** argv )
{
   ...
   //sleep(1);
    ...
    Mat image1;
    //Read an image
    //cout << "Image Cols : " << image1.cols << "Image Rows : " << image.rows << endl;

    image1 = imread("/home/amazon/cvprojects/task1/v1.4/img2.jpg", CV_LOAD_IMAGE_COLOR);   // Read the file 
    //cout << "Image Cols : " << image1.cols << "Image Rows : " << image.rows << endl;

    
    selection = Rect(0, 0, image1.cols, image1.rows);
    //cout << "X: " << selection.x << " Y: " << selection.y << endl;
	...
	if(true)
        {
             ...
             bool right = false, left = false, forward = false, backward = false, stop = false;
            
            if(c2x >= (image.cols/2) + 90 )
            {
                //turn right
                right = true;
		...
		//cout << "left: " << left << endl;
            ...
            if((currentarea / (image.rows * image.cols)) < 0.1)
            {
                //move forward
                forward = true;
		//cout << "forward: " << currentarea / (image.rows * image.cols) << endl;

            }
            else  if((currentarea / (image.rows * image.cols)) >= 0.2)
            {
                //move backward
                backward = true;
		//cout << "backward: " << currentarea / (image.rows * image.cols) << endl;
	   ...
	   if((forward == true) && (right == true)){
		...
		decision = 'r';
		cout << "decision: " << "right" << endl;}
	   else if((forward == true)){
		decision = 'f';
		cout << "decision: " << "forward" << endl;}
          else if((right == true) && (backward == true)){
		decision = 'b';
		cout << "decision: " << "backward" << endl;}
          else if((left == true)   && (backward == true)){
		decision = 'b';
		cout << "decision: " << "backward" << endl;}
	  else if((left == true) && (forward == true)){
		decision = 'l';
		cout << "decision: " << "left" << endl;}
	  else if((left == true)) {
		decision = 'l';
		cout << "decision: " << "left" << endl;}
	 else if((right == true)) {
